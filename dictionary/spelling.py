...
with open("pangrams.json", "w") as outfile:
    json.dump(pangrams, outfile)
with open("hivewords.json", "w") as outfile:
    json.dump(hivewords, outfile)
with open("hivedictionary.json", "w") as outfile:
    json.dump(hivedictionary, outfile)
